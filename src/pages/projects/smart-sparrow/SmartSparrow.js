...
const description =
  'The future of education is likely to be shaped by technological advancements and changing social and economic needs. The pandemic has accelerated the shift towards online and hybrid learning, but even after the pandemic subsides, it is likely that education will become more flexible and adaptable.';
const roles = [
  'Art Direction',
  'UX and UI Design',
        ...
        <ProjectSection>
          <ProjectTextRow>
            ...
            <ProjectSectionText>
              ...
              Despite advances in technology, access to quality education remains a major challenge in many parts of the world. Some students may lack the resources or infrastructure necessary to participate in online learning, and others may face barriers due to socio-economic factors or discrimination.
              As the nature of education changes, it will be important to train teachers to adapt to new teaching methods and technologies.
              : The cost of education continues to rise, and this could make it harder for students to access higher education or obtain the skills they need to succeed in the workforce. This could lead to greater inequality and reduce social mobility.
            </ProjectSectionText>
          </ProjectTextRow>
        </ProjectSection>
          ...
          <Earth
            ...
            labels={useMemo(
              () => [
                ...
                {
                  position: [-0.10, 0.20, 0.58],
                  text: 'India',
                  hidden: true,
                },
                {
                  position: [-0.10, 0.30, 0.58],
                  text: 'Nepal',
                  hidden: true,
                },
                {
                  position: [-0.10, 0.40, 0.58],
                  text: 'China',
                  hidden: true,
                },
                {
              ...
              <ProjectSection>
                <ProjectSectionContent>
                  <ProjectTextRow center>
                    ...
                    <ProjectSectionText>
                      Next-generation learning experiences will be characterized by greater personalization, interactivity, and flexibility. Technology will play a crucial role in enabling personalized learning, as well as providing opportunities for students to engage with course material in new and innovative ways. Blended learning approaches will become increasingly common, combining traditional classroom instruction with online and hybrid learning
                    </ProjectSectionText>
                  </ProjectTextRow>
                </ProjectSectionContent>
              </ProjectSection>
              ...
              <ProjectSection>
                <ProjectSectionContent width="xl">
                  <ProjectTextRow justify="end" width="s">
                    ...
                    <ProjectSectionText>
                    By creating 3D models and interactive simulations, students can visualize and explore abstract ideas in a more tangible and immersive way. Additionally, 3D printing technology can allow students to physically create and manipulate objects, providing a hands-on learning experience. 
                    </ProjectSectionText>
                  </ProjectTextRow>
                </ProjectSectionContent>
              </ProjectSection>
